<template>
  <span class="chrome-inactive-shortcuts-css-vars">
    <slot></slot>
  </span>
</template>

<style scoped>
.chrome-inactive-shortcuts-css-vars {
...
@media (prefers-color-scheme: dark) {
  .chrome-inactive-shortcuts-css-vars {
    ...
    --cr-menu-shadow: rgba(0, 0, 0, 0.3) 0 1px 2px 0,
...
.chrome-inactive-shortcuts-css-vars {
  --settings-disabled-opacity: 0.65;
